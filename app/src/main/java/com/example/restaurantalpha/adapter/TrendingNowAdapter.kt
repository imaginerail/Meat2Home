...
class TrendingNowAdapter(
    val context: Context, var itemList: ArrayList<TrendingNow>
) :
    RecyclerView.Adapter<TrendingNowAdapter.HomeViewHolder>() {

    var searchFilterList = ArrayList<TrendingNow>()
    var totalCost: Int = 0
    ...
    class HomeViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val txtcutcost: TextView = view.findViewById(R.id.txtcutcost)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.trending_recycler_single_row, parent, false)
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        ...
        holder.txtcutcost.text = "₹${restaurants.cutcost}"
        holder.txtDiscount.text="${restaurants.discount}% Off"
