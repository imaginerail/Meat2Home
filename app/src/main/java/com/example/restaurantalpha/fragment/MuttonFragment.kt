...
class MuttonFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mutton, container, false)
            ...
            ref.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    p0.children.forEach {
                        ...
                        val fd=Food(food!!.id,"Mutton",food.cost,food.image,food.name)
                        itemList.add(fd)
                    }
